...
![Customer Info](Code_Output/email.png)

### 2. Count of Movies with Rental Rate of $0.99
![Cheapest Rental](Code_Output/CHEAPEST_RENTALS.png)

### 3. Rental Rate Distribution and Movie Count
![Total Movies per Rental Rate](Code_Output/TOTAL_NUMBER_OF_MOVIES.png)

### 4. Most Common Movie Rating
![Rating Count](Code_Output/RATING_WISE_COUNT.png)
